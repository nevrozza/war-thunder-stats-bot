...
webhook_squadrons = DiscordWebhook(url = process.env.webhook_squadrons)
webhook_channel_players_2 = DiscordWebhook(url = process.env.webhook_channel_players_2)
webhook_channel_players = DiscordWebhook(url = process.env.webhook_channel_players)
